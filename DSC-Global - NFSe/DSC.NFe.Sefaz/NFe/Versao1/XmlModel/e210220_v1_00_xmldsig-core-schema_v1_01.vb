...
'
Namespace Nfe.Versao1.XmlModel.E210220
    ...
    Partial Public Class detEvento
        Inherits Object
        Implements System.ComponentModel.INotifyPropertyChanged

        Private descEventoField As detEventoDescEvento

        Private xJustField As String

        Private versaoField As detEventoVersao

        '''<remarks/>
        Public Property descEvento() As detEventoDescEvento
            Get
                Return Me.descEventoField
            End Get
            Set(value As detEventoDescEvento)
        ...
        Public Property versao() As detEventoVersao
            Get
                Return Me.versaoField
            End Get
            Set(value As detEventoVersao)
