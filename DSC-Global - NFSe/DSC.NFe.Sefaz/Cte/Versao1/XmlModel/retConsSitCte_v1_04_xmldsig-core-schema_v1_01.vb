...
'
Namespace Cte.Versao1.XmlModel.RetConsSitCte
    ...
    Partial Public Class TRetConsSitCTe
        ...
        Private procEventoCTeField() As TProcEvento
    ...
    Partial Public Class TProcEvento
        ...
        Private eventoCTeField As TEvento

        Private retEventoCTeField As TRetEvento

        Private versaoField As String

        '''<remarks/>
        Public Property eventoCTe() As TEvento
            Get
                Return Me.eventoCTeField
            End Get
            Set(ByVal value As TEvento)
                Me.eventoCTeField = value
                Me.RaisePropertyChanged("eventoCTe")
            End Set
        End Property

        '''<remarks/>
        Public Property retEventoCTe() As TRetEvento
            Get
                Return Me.retEventoCTeField
            End Get
            Set(ByVal value As TRetEvento)
                Me.retEventoCTeField = value
                Me.RaisePropertyChanged("retEventoCTe")
            End Set
        End Property
