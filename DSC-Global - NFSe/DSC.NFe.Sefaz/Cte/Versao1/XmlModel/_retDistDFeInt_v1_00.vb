...
'
Namespace Cte.Versao1.XmlModel.RetDistDFeInt_ANTIGO
 ...
 System.Xml.Serialization.XmlRootAttribute([Namespace]:="http://www.portalfiscal.inf.br/nfe", IsNullable:=False)>
    Partial Public Class retDistDFeInt
        ...
        Public tpAmbField As TAmb

        Public verAplicField As String

        Public cStatField As String

        Public xMotivoField As String

        Public dhRespField As String

        Public ultNSUField As String

        Public maxNSUField As String

        Public loteDistDFeIntField As retDistDFeIntLoteDistDFeInt

        Public versaoField As TVerDistDFe
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://www.portalfiscal.inf.br/nfe")>
    Partial Public Class retDistDFeIntLoteDistDFeInt
        ...
        Public docZipField() As retDistDFeIntLoteDistDFeIntDocZip
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://www.portalfiscal.inf.br/nfe")>
    Partial Public Class retDistDFeIntLoteDistDFeIntDocZip
        ...
        Public nSUField As String

        Public schemaField As String

        Public valueField() As Byte
