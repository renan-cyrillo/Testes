...
'
Namespace Cte.Versao1.WSDL.Consulta
    ...
    Partial Public Class CteConsulta
        ...
        Public Sub New()
            ...
            Me.Url = "https://cte.sefaz.rs.gov.br/ws/cteconsulta/cteconsulta.asmx"
        End Sub
        ...
        '''<remarks/>
        Public Function BegincteConsultaCT(ByVal cteDadosMsg As System.Xml.XmlNode, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("cteConsultaCT", New Object() {cteDadosMsg}, callback, asyncState)
        End Function

        '''<remarks/>
        Public Function EndcteConsultaCT(ByVal asyncResult As System.IAsyncResult) As System.Xml.XmlNode
