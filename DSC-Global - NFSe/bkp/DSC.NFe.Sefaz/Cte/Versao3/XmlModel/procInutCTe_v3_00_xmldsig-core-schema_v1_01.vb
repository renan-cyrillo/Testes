...
'
Namespace Cte.Versao3.XmlModel.procInutCTe
    ...
    Partial Public Class TInutCTeInfInut
        ...
        Private modField As TModCT_Carga_OS
        ...
        '''<remarks/>
        Public Property [mod]() As TModCT_Carga_OS
            Get
                Return Me.modField
            End Get
            Set(ByVal value As TModCT_Carga_OS)
                Me.modField = Value
            End Set
        End Property
