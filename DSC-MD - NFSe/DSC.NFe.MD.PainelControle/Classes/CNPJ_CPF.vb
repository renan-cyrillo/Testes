Namespace DSC.Global

    Public Class CNPJ_CPF
...
#Region " CPF "
        ...
        Public Property cpf() As String
            ...
            Set(ByVal Valor As String)
                bValida = ValidaCPF(Valor.ToString())
                If bValida Then
                    sCPF = Valor
                Else
        ...
        Public ReadOnly Property isCpfValido() As Boolean
            Get
                bValida = ValidaCPF(cpf.ToString())
                If bValida Then
                    Return True
                Else
                    Return False
...
#Region " CNPJ "
        ...
        Public Property cnpj() As String
            ...
            End Get
            Set(ByVal Valor As String)
                bValida = ValidaCNPJ(Valor.ToString())
                If bValida Then
                    sCNPJ = Valor
                Else
        ...
        Public ReadOnly Property isCnpjValido() As Boolean
            Get
                bValida = ValidaCNPJ(cnpj.ToString())
                If bValida Then
                    Return True
                Else
                    Return False
