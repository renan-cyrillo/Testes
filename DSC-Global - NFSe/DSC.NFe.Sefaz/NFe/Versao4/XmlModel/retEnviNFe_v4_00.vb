...
'
Namespace Nfe.Versao4.XmlModel.RetEnviNFe
    '''<remarks/>
 ...
 System.Xml.Serialization.XmlRootAttribute("retEnviNFe", [Namespace]:="http://www.portalfiscal.inf.br/nfe", IsNullable:=False)>
    Partial Public Class TRetEnviNFe
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("infRec", GetType(TRetEnviNFeInfRec)),
     System.Xml.Serialization.XmlElementAttribute("protNFe", GetType(TProtNFe))>
