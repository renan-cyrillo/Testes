...
Namespace Nfe.Versao2.WSDL.Consulta
    '
    ...
    Partial Public Class NfeConsulta2
        ...
        Public Sub New()
            ...
            Me.Url = "https://homologacao.nfe.fazenda.sp.gov.br/nfeweb/services/NfeConsulta2.asmx"
        End Sub
...
'Namespace Local.Nfe.Versao2.WSDL.Consulta
'    '------------------------------------------------------------------------------
'    ' <auto-generated>
'    '     O código foi gerado por uma ferramenta.
'    '     Versão de Tempo de Execução:2.0.50727.8009
...
'                MyBase.New()
'                Me.SoapVersion = System.Web.Services.Protocols.SoapProtocolVersion.Soap12
'                Me.Url = "https://nfe.sefaz.pe.gov.br/nfe-service/services/NfeConsulta2"
'            End Sub
...
'                Dim results() As Object = Me.Invoke("nfeConsultaNF2", New Object() {nfeDadosMsg})
'                Return CType(results(0), System.Xml.XmlNode)
'                'Dim teste = Me.Invoke("nfeConsultaNF2", New Object() {nfeDadosMsg})

'                ''Aqui ele envia o XML e recebe o retorno
'                'Dim results() As Object = teste

'                ''Aqui ele tenta converter o xml retornado em um XML
'                ''É aqui que da Pau
'                'Return CType(results(0), System.Xml.XmlNode)
'            End Function
