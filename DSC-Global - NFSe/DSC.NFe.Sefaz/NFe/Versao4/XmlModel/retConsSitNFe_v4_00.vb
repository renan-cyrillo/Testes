...
'
Namespace Nfe.Versao4.XmlModel.RetConsSitNFe
    '''<remarks/>
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://www.portalfiscal.inf.br/nfe")>
    Partial Public Class TRetEventoInfEvento
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("CNPJDest", GetType(String)),
     System.Xml.Serialization.XmlElementAttribute("CPFDest", GetType(String)),
     System.Xml.Serialization.XmlChoiceIdentifierAttribute("ItemElementName")>
        Public Property Item() As String
            Get
                Return Me.itemField
