...
'
Namespace Cte.Versao2.XmlModel.evRegMultimodal
    ...
    Partial Public Class evRegMultimodal
        Inherits Object
        Implements System.ComponentModel.INotifyPropertyChanged

        Private descEventoField As evRegMultimodalDescEvento

        Private xRegistroField As String

        Private nDocField As String

        '''<remarks/>
        Public Property descEvento() As evRegMultimodalDescEvento
            Get
                Return Me.descEventoField
            End Get
            Set(ByVal value As evRegMultimodalDescEvento)
        ...
        '''<remarks/>
        Public Property xRegistro() As String
            Get
                Return Me.xRegistroField
            End Get
            Set(ByVal value As String)
                Me.xRegistroField = value
                Me.RaisePropertyChanged("xRegistro")
            End Set
        End Property
    ...
    Public Enum evRegMultimodalDescEvento
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlEnumAttribute("Registro Multimodal")> _
        RegistroMultimodal
    End Enum
