...
'
Namespace Nfe.Versao3.XmlModel.RetEnviNFe
    ...
    Partial Public Class TRetEnviNFe
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("infRec", GetType(TRetEnviNFeInfRec)), _
         System.Xml.Serialization.XmlElementAttribute("protNFe", GetType(TProtNFe))> _
