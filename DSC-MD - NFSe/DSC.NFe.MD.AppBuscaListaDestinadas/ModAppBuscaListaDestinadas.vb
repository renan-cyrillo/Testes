...
Module ModAppBuscaListaDestinadas
...
#End If
    ...
    Private Sub BuscaListaDestinadas(ByVal client As PainelControleController)
    ...
    Private Function GetXmlSefaz(ByVal client As PainelControleController, ByRef UltNSU As String, ByRef status As String, ByRef motivo As String, ByRef maxNSU As Integer, ByRef retDistDFeInt As Global.DSC.NFe.Sefaz.Nfe.Versao1.XmlModel.RetconsNFeDest12.retDistDFeInt) As String
        ...
        Try
            ...
            testeWSDL.SoapVersion = Web.Services.Protocols.SoapProtocolVersion.Soap12
            testeWSDL.RequestEncoding = System.Text.Encoding.UTF8
            testeWSDL.Url = "https://nfe.prefeitura.sp.gov.br/ws/lotenfe.asmx"
            ...
            XmlNodeRetTeste = testeWSDL.ConsultaNFeRecebidas(1, xmlTeste)
            ...
            Dim retConsulta = DeserializeXmlStringToObject(XmlNodeRetTeste, XmlNodeRetTeste.GetType)
