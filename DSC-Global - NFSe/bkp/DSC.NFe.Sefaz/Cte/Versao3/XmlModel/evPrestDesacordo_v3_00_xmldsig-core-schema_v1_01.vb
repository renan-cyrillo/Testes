...
'
Namespace Cte.Versao3.XmlModel.evPrestDesacordo
    ...
    Partial Public Class evPrestDesacordo

        Private descEventoField As evPrestDesacordoDescEvento

        Private indDesacordoOperField As evPrestDesacordoIndDesacordoOper

        Private xObsField As String

        '''<remarks/>
        Public Property descEvento() As evPrestDesacordoDescEvento
            Get
                Return Me.descEventoField
            End Get
            Set(ByVal value As evPrestDesacordoDescEvento)
                Me.descEventoField = Value
            End Set
        End Property

        '''<remarks/>
        Public Property indDesacordoOper() As evPrestDesacordoIndDesacordoOper
            Get
                Return Me.indDesacordoOperField
            End Get
            Set(ByVal value As evPrestDesacordoIndDesacordoOper)
                Me.indDesacordoOperField = Value
            End Set
        End Property
    ...
    Public Enum evPrestDesacordoDescEvento
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlEnumAttribute("Prestação do Serviço em Desacordo")> _
